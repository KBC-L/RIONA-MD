...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("RIONA-MD&~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log(" RIONA MD is starting...💃");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🧚‍♂️ **© ʀɪᴏɴᴀ-ᴍᴅ 💃 Connected Successfully!** ✅ 
          
          --- **🧚‍♂️ Welcome to © ʀɪᴏɴᴀ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ 💃!** 🫀 
          ...
          --- Thank you for using **© ʀɪᴏɴᴀ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ 💃**. 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94703973470@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363419184207379@newsletter",
            newsletterName: "© ʀɪᴏɴᴀ-ᴍᴅ 💃",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© ʀɪᴏɴᴀ-ᴍᴅ 💃",
            body: " © ᴄʜᴀᴍɪɴᴅᴜ ʟᴀᴋꜱʜᴀɴ 🧑‍💻",
            mediaType: 1,
            sourceUrl: "https://github.com/KBC-L/RIONA-MD",
            thumbnailUrl:
              "https://ibb.co/9HqTkW16", // This should match the image URL provided above
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("ʜᴇʏ ɪ'ᴀᴍ ᴀʟɪᴠᴇ, RIONA-MD Is started✅");
});
app.listen(port, () =>
